...
<head>
    ...
    <title>Cozy Comfort | Premium Blanket Manufacturer</title>
...
<body>
    ...
    <main class="main-content">
        <section class="access-panel">
            ...
            <p class="panel-subtitle">Select your role to access the appropriate system</p>
            
            <div class="button-grid">
                
                <a href="Manufacturer/login.php" class="access-button">
                    <i class="fas fa-industry"></i>
                    <span>Manufacturer</span>
                </a>
                <a href="Distributor/login.php" class="access-button">
                    <i class="fas fa-truck"></i>
                    <span>Distributor</span>
                </a>
                <a href="Seller/login.php" class="access-button">
                    <i class="fas fa-store"></i>
                    <span>Seller</span>
                </a>
                <a href="User/login.php" class="access-button">
