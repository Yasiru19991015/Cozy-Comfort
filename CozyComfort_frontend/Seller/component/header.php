...
<body>
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="./sellerinventory.php" class="nav-link">Blankets Store</a>
            <a href="./userpendingorders.php" class="nav-link">Orders</a>
            <a href="./orderhistory.php" class="nav-link">Order History</a>
        ...
        <div class="nav-actions">
            <a href="./sellerbuyblankets.php" class="btn btn-primary btn-float">
        ...
        <div class="mobile-nav" id="mobileNav">
            <div class="mobile-nav-links">
                ...
                <a href="./sellerinventory.php" class="mobile-nav-link"> <i class="fas fa-blanket"></i>
                    Blankets Store
                </a>
                <a href="./userpendingorders.php" class="mobile-nav-link">
                    <i class="fas fa-clipboard-list"></i> Orders
                </a>
                <a href="./orderhistory.php" class="mobile-nav-link">
                ...
                <a href="./ourmaterials.php" class="mobile-nav-link">
                    <i class="fas fa-compass"></i> Our Materials
                </a>
            </div>

            <div class="mobile-nav-actions">
                <a href="./sellerbuyblankets.php" class="btn btn-primary">
                    <i class="fas fa-shopping-cart"></i>
                    Order Now
                </a>
            </div>
            ...
            <?php if (isset($_SESSION['user_id'])) : ?>
                ...
                <a href="settings.php" class="mobile-nav-link"> <i class="fas fa-cog"></i>
                    Settings
                </a>
                <a href="orders.php" class="mobile-nav-link"> <i class="fas fa-shopping-bag"></i>
                    My Orders
                </a>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            class Navigation {
                constructor() {
                    ...
                    this.userDropdownContent = document.getElementById('userDropdownContent');
                ...
                init() {
                    ...
                    if (this.userDropdownToggle) {
                        ...
                        document.addEventListener('click', (event) => {
                            if (!this.userDropdown.contains(event.target) && this.userDropdown.classList.contains('active')) {
                ...
                highlightActiveLink() {
                    this.navLinks.forEach(link => {
                        ...
                        if (this.currentPage === 'dashboard.php' && (linkPage === 'dashboard.php' || linkPage === '')) {
                            link.classList.add('active');
                        } 
                        
                        else if (this.currentPage === linkPage) {
                            link.classList.add('active');
                        }
                    });
                }
