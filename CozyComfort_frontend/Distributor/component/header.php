...
<body>
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="./distributor_inventory.php" class="nav-link">Blankets Store</a>
            <a href="./sellerpendingorder.php" class="nav-link">Orders</a>
        ...
        <div class="nav-actions">
            <a href="ordertomanufacture.php" class="btn btn-primary btn-float">
